...
def adminlist(request):
    ...
    # 渲染模板文件：templates/admins/list.html
    return render(request , "admins/list.html" , locals() )
...
def adminadd(request):
    ...
    # 渲染模板文件：templates/admins/add.html
    return render(request , "admins/add.html",locals())
...
def adminupdt(request):
    ...
    # 渲染模板文件：templates/admins/updt.html
    return render(request, "admins/updt.html" , locals())
...
def adminupdtself(request):
    ...
    # 设置为更新用户资料
    updtself = 1
    # 渲染模板文件：templates/admins/updtself.html
    return render(request, "admins/updtself.html" , locals())
...
def insert(request):
    ...
    # 新建Admins 对象，用AdminsModel 对象进行对数据进行插入
    model = Admins(**data)
    # 执行插入数据
...
def update(request):
    ...
    # 新建Admins 对象，用AdminsModel 对象进行对数据进行更新
    model = Admins(**data)
    # 执行更新操作
